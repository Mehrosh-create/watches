              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <Link href="/wishlist" className="relative flex items-center text-gray-600 hover:text-gray-900">
                    ...
                    {/* Dynamic count will be added via useWishlist hook */}
                    <span className="wishlist-count absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                      0
                    </span>
                  </Link>
